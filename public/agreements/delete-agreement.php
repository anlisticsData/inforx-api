...
use UseCases\Agreements\DeleteAgreementUseCase;
...
try {
    ...
    $deleteAgreementUseCase =  new DeleteAgreementUseCase(new AgreementRepository(),new BranchesRepository());
    $result=$deleteAgreementUseCase->execute($branch,$request->id);
