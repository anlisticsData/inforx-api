...
class InformationOfPaymentsByPlateUseCase
{
        ...
        try {
            ...
            if (is_null($vehicleAndMonthlyFee)) {
                ...
                */
                ...
                $debitsOpen = 0;
                $total = $vehicleAndMonthlyFee['monthly_fee_amount'];
                $inputPaymentOfMonthlyPayments = [
                    "fk_monthly_payer" => $vehicleAndMonthlyFee['monthly_id']
                ];
                $paymentIsPendents = $this->checkMonthlyPaymentUseCase->execute(new PaymentOfMonthlyPayments($inputPaymentOfMonthlyPayments));
                ...
                $validate =$vehicleAndMonthlyFee['monthly_day_expiry_date'];
                $data_inicial =$vehicleAndMonthlyFee['monthly_date_registration'];
                $data_final = Uteis::addDaysToDate($data_inicial, $validate);
                ...
                $GeneralCarInformationDto =  new GeneralCarInformationDto(
                    [
                        ...
                        "used_grid" => null,
                        "total" => number_format($total, 2),
                        "monthly_day_expiry_date" =>  $data_final,
                        "outstanding_debts" => $paymentsDebts,
                        "intervals_used" => null,
                        "balance"=>$total,
                        "validade"=> $validate
