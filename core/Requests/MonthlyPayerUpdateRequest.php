...
class MonthlyPayerUpdateRequest  implements IRequestValidate{
    ...
    function isValid()
    {
        if(Uteis::isNullOrEmpty($this->id) || Uteis::isNullOrEmpty($this->name) 
        || Uteis::isNullOrEmpty($this->address) || Uteis::isNullOrEmpty($this->cep)
        || Uteis::isNullOrEmpty($this->number)){
