...
class PdoMysqlModuleAdapter implements IConnections{
    private $pdo=null;
    private $servername;
    private $username ;
    private $password ;
    ...
    function __construct()
    {
        ...
        $this->servername =  $_SERVER["MYSQL_MODULE_LOCALHOST"];
        $this->username =    $_SERVER["MYSQL_MODULE_USER"];
        $this->password =    $_SERVER["MYSQL_MODULE_USER_PASSWORD"];
        $this->port =        $_SERVER["MYSQL_MODULE_PORT"];
        $this->database =    $_SERVER["MYSQL_MODULE_DATABASE"];
